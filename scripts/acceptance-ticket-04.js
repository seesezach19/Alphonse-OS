...
const kernelUrl = "http://127.0.0.1:43104";
const dataPlaneUrl = "http://127.0.0.1:43114";
const agentToken = "ticket-04-agent-token-0000000000000001";
const authHeaders = { "content-type": "application/json", authorization: "Bearer local-development-bootstrap-token" };
const composeEnvironment = {
  ...process.env,
  COMPOSE_PROJECT_NAME: "alphonse-kernel-ticket-04-acceptance",
  KERNEL_PORT: "43104",
  POSTGRES_PORT: "45435",
  DATA_PLANE_PORT: "43114"
};
...
async function waitUntilHealthy() {
  ...
  throw new Error("Ticket 04 services did not become healthy.");
}
...
try {
  ...
  const passport = await post("/kernel/v0/agent-passports", command("t04-passport", "kernel.agent_passport.issue", {
    ...
    permitted_intent_classes: ["package_build"], provenance: { source: "ticket-04-acceptance" },
  ...
  console.log("Ticket 04 black-box acceptance passed.");
} finally {
  compose("down", "--volumes", "--remove-orphans");
}
