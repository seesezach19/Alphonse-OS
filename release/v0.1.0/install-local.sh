...
project_name=${ALPHONSE_COMPOSE_PROJECT:-alphonse-kernel-v0-1}
...
STOREFRONT_CREDENTIAL_ISSUER_SECRET=$(secret)
ADAPTER_BROKER_TOKEN=$(secret)
EOF
fi
...
printf '%s\n' "Alphonse Kernel V0.1 ready: http://127.0.0.1:$kernel_port/kernel/v0/bootstrap"
