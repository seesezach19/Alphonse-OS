...
export const DIAGNOSTIC_WORKER_OUTPUT_SCHEMA_V0_2 = Object.freeze({
  ...
  properties: {
    ...
    best_supported_hypothesis: {
      ...
      properties: {
        ...
        observed_identity_scope: { type: "string", enum: [
          "logical_operation", "delivery", "workflow", "integration", "provider", "unknown"
        ] },
        required_identity_scope: { type: "string", enum: [
          "logical_operation", "delivery", "workflow", "integration", "provider", "unknown"
        ] },
    ...
    identity_cardinality: {
      type: "object",
      additionalProperties: false,
      required: ["deliveries", "logical_operations"],
      properties: {
    ...
    supporting_evidence: {
      type: "array", minItems: 5, maxItems: 64, items: { $ref: "#/$defs/citation" }
    },
    counterevidence: {
      type: "array", maxItems: 64, items: { $ref: "#/$defs/citation" }
    },
    alternatives: {
      type: "array",
      maxItems: 20,
    ...
    citation: {
      ...
      properties: {
        role: { type: "string", enum: [
          "behavior_contract", "correlation_projection", "destination_request",
          "interpreted_effect", "source_delivery"
        ] },
        reference_type: { type: "string", enum: [
          "behavior_contract", "correlation_projection", "diagnostic_effect_projection",
          "diagnostic_observation_receipt"
        ] },
...
export function validateDiagnosticAssignmentPolicy(value) {
  ...
  if (!same(value.output_schema, DIAGNOSTIC_WORKER_OUTPUT_SCHEMA_V0_2)) {
    fail("diagnostic_assignment_policy.output_schema must use the complete neutral v0.2 output contract.");
  }
